...
TESTFILE_POPULARITY = os.path.join(os.path.dirname(
    __file__), "./snapshots/test_popularity.json")
TESTFILE_POPULARITY = os.path.join(os.path.dirname(
    __file__), "./snapshots/test_popularity.json")
TESTFILE_LAUNCH_DATE = os.path.join(os.path.dirname(
    __file__), "./snapshots/test_launch_date.json")
TESTFILE_DISTANCE = os.path.join(os.path.dirname(
    __file__), "./snapshots/test_distance.json")
