...
TESTFILE_INCORRECT_DATA = os.path.join(
    os.path.dirname(__file__), "./snapshots/incorrect.json")
...
class JsonTest(unittest.TestCase):
    ...
    def test_dataframe_to_json(self):
        ...
        result, example = JSON.dumps(json_returned, sort_keys=True), JSON.dumps(
            json_test_out, sort_keys=True)
